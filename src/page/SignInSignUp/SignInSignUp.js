...
function LeftComponent() {
  return (
    <Col className="signin-signup__left" xs={6}>
      ...
      <div>
        <h2>
          <FontAwesomeIcon icon={faSearch} /> Follow what you're interested in.
        </h2>
        <h2>
          <FontAwesomeIcon icon={faUsers} /> Find out what everyone is talking
          about.
        </h2>
        <h2>
  ...
  return (
    <Col className="signin-signup__right" xs={6}>
      <div>
        ...
        <h2>Watch what's happening in the world right now.</h2>
        <h2>Join Twittor now.</h2>
        <Button
          variant="primary"
